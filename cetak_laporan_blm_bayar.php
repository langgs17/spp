...
//echo "id siswa = $nisn";
	...
	<body onload="window.print();">
		...
		<table border="1" cellspacing="" cellpadding="6" width="100%">
			...
			<?php
			$spp	= mysqli_query($conn, "SELECT siswa.*,pembayaran.* FROM siswa, pembayaran WHERE pembayaran.nisn = siswa.nisn AND tglbayar BETWEEN '$awal' AND '$akhir' AND siswa.nisn=$nisn AND ket='BELUM DIBAYAR' ORDER BY nobayar");
			$i 		= 1;
			$total	= 0;
